...
%o`, message, error2, detail);
  ...
  var nested_form_controller_default = class extends Controller {
    ...
    add(event) {
      ...
      const uniqueId = (/* @__PURE__ */ new Date()).getTime() + Math.floor(Math.random() * 1e6);
    ...
    updateCount() {
      const visibleChoices = Array.from(this.containerTarget.querySelectorAll(".nested-fields")).filter((item) => {
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=/assets/application-d946d650.js.map
