...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference("Diary.count") do
      post diaries_url, params: { diary: { color: @diary.color, content: @diary.content, diary_date: @diary.diary_date } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { color: @diary.color, content: @diary.content, diary_date: @diary.diary_date } }
